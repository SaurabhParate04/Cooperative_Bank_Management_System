...
public class Home extends javax.swing.JFrame {
    ...
    private void setUpCustomerList() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                HomeCustomerListTable.getColumnModel().getColumn(1).setCellRenderer(cellRenderer);
                HomeCustomerListTable.getColumnModel().getColumn(2).setCellRenderer(cellRenderer);
                HomeCustomerListTable.getColumnModel().getColumn(3).setCellRenderer(cellRenderer);
                HomeCustomerListTable.setAutoCreateRowSorter(true);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void setUpTransactionTableSent() {
        try {
            ...
            while(rs.next()) {
                ...
                int m = -1 * rs.getInt(5);
                model.addRow(new Object[]{d,"Sent",f+" "+l,a,m});
    ...
    private void setUpTransactionTableReceived() {
        try {
            ...
            while(rs.next()) {
                ...
                String l = rs.getString(3);
                String d = rs.getString(4);
                String m = String.valueOf(rs.getInt(5));
                DefaultTableModel model = (DefaultTableModel) (HomeTransactionsTable.getModel());
                model.addRow(new Object[]{d,"Received",f+" "+l,a,"+"+m});
                HomeTransactionsTable.setEnabled(false);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
    ...
    private void setUpTransactionTableLogs() {
        try {
            String sql = "select Date, Type, Amount from logs where Acc_No = '"+acc+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            while(rs.next()) {
                String d = rs.getTimestamp(1).toString().substring(0,19);
                String t = rs.getString(2);
                int a = rs.getInt(3);
                String am = String.valueOf(a);
                if(t.equals("Withdraw") || t.equals("EMI") || t.equals("Early Settlement")) {
                    am = "-"+am;
                } else {
                    am = "+"+am;
                }
                DefaultTableModel model = (DefaultTableModel) (HomeTransactionsTable.getModel());
                model.addRow(new Object[]{d,t,"-","-",am});
                HomeTransactionsTable.setEnabled(false);
                JTableHeader header = HomeTransactionsTable.getTableHeader();
                header.setBackground(Color.white);
                HomeTransactionsTable.setFillsViewportHeight(true);
                HomeTransactionsTable.getColumnModel().getColumn(0).setPreferredWidth(140);
                HomeTransactionsTable.getColumnModel().getColumn(4).setPreferredWidth(40);
                HomeTransactionsTable.getColumnModel().getColumn(3).setPreferredWidth(50);
                DefaultTableCellRenderer cellRenderer = new DefaultTableCellRenderer();
                cellRenderer.setHorizontalAlignment(JLabel.CENTER);
                HomeTransactionsTable.getColumnModel().getColumn(0).setCellRenderer(cellRenderer);
                HomeTransactionsTable.getColumnModel().getColumn(1).setCellRenderer(cellRenderer);
                HomeTransactionsTable.getColumnModel().getColumn(2).setCellRenderer(cellRenderer);
                HomeTransactionsTable.getColumnModel().getColumn(3).setCellRenderer(cellRenderer);
                HomeTransactionsTable.getColumnModel().getColumn(4).setCellRenderer(cellRenderer);
                HomeTransactionsTable.setAutoCreateRowSorter(true);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void setUpLoanRequestTable() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                DefaultTableCellRenderer cellRenderer = new DefaultTableCellRenderer();
                cellRenderer.setHorizontalAlignment(JLabel.CENTER);
                HomeLoanRequestTable.getColumnModel().getColumn(0).setCellRenderer(cellRenderer);
                HomeLoanRequestTable.getColumnModel().getColumn(1).setCellRenderer(cellRenderer);
                HomeLoanRequestTable.getColumnModel().getColumn(2).setCellRenderer(cellRenderer);
                HomeLoanRequestTable.getColumnModel().getColumn(3).setCellRenderer(cellRenderer);
                HomeLoanRequestTable.setAutoCreateRowSorter(true);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void setUpLoanTable() {
        ...
        model.fireTableDataChanged();
        try {
            String sql = "select Acc_No, Loan_Approve_Date, Loan_Amount, Loan_Duration, Current_Installment from account where Is_Loan_Pending = '"+1+"'";
            pst = conn.prepareStatement(sql);
            rs = pst.executeQuery();
            while(rs.next()) {
                int a = rs.getInt(1);
                ...
                int yr = rs.getInt(4);
                int i = rs.getInt(5);
                model.addRow(new Object[]{a,d,am,yr,i-1});
                HomeLoanTable.setEnabled(false);
                JTableHeader header = HomeLoanTable.getTableHeader();
                header.setBackground(Color.white);
                HomeLoanTable.setFillsViewportHeight(true);
                HomeLoanTable.getColumnModel().getColumn(1).setPreferredWidth(130);
                HomeLoanTable.getColumnModel().getColumn(0).setPreferredWidth(55);
                HomeLoanTable.getColumnModel().getColumn(3).setPreferredWidth(40);
                DefaultTableCellRenderer cellRenderer = new DefaultTableCellRenderer();
                cellRenderer.setHorizontalAlignment(JLabel.CENTER);
                HomeLoanTable.getColumnModel().getColumn(0).setCellRenderer(cellRenderer);
                HomeLoanTable.getColumnModel().getColumn(1).setCellRenderer(cellRenderer);
                HomeLoanTable.getColumnModel().getColumn(2).setCellRenderer(cellRenderer);
                HomeLoanTable.getColumnModel().getColumn(3).setCellRenderer(cellRenderer);
                HomeLoanTable.getColumnModel().getColumn(4).setCellRenderer(cellRenderer);
                HomeLoanTable.setAutoCreateRowSorter(true);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void setUpAdminTable() {
        ...
        try {
            ...
            while(rs.next()) {
                ...
                DefaultTableCellRenderer cellRenderer = new DefaultTableCellRenderer();
                cellRenderer.setHorizontalAlignment(JLabel.CENTER);
                HomeAdminTable.getColumnModel().getColumn(0).setCellRenderer(cellRenderer);
                HomeAdminTable.getColumnModel().getColumn(1).setCellRenderer(cellRenderer);
                HomeAdminTable.getColumnModel().getColumn(2).setCellRenderer(cellRenderer);
                HomeAdminTable.getColumnModel().getColumn(3).setCellRenderer(cellRenderer);
            }
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e);
        }
    ...
    private void addInterest() {
        ...
        DateTimeFormatter f = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss");
        LocalDateTime cDate = LocalDateTime.parse(currentDate, f);
        String q = "select Date_of_Interest, Baseline_Bal, Non_Maintenance from account where Acc_No = '"+acc+"'";
        try {
            pst = conn.prepareStatement(q);
            rs = pst.executeQuery();
            if(rs.next()) {
                LocalDateTime iDate = rs.getTimestamp(1).toLocalDateTime();
                int iBal = rs.getInt(2);
                int p = rs.getInt(3);
                if(p == 0) {
                    interestRate = 0.035;
                } else {
                ...
                if(y > 0) {
                    int interest = (int)(iBal * interestRate * (y));
                    String q1 = "update balance set Balance = Balance + '"+interest+"' where Account_No = '"+acc+"'";
                    pst = conn.prepareStatement(q1);
                    pst.execute();
                    String q3 = "select Balance from balance where Account_No = '"+acc+"'";
                    pst = conn.prepareStatement(q3);
                    rs = pst.executeQuery();
                    if(rs.next()) {
                        newBal = rs.getInt(1);
                        LocalDateTime nDate = iDate.plusYears(1);
                        String q2 = "update account set Date_of_Interest = '"+nDate+"', Baseline_Bal = '"+newBal+"', Non_Maintenance = '"+0+"' where Acc_No = '"+acc+"'";
                        pst = conn.prepareStatement(q2);
                        pst.execute();
                        JOptionPane.showMessageDialog(null, "Interest of '"+interest+"'Rs has been credited to your account");
    ...
    private void setUpWithdrawLogs(int am) {
        Random r = new Random();
        String d = getDateTime();
        String t = d.substring(2,4) + d.substring(5,7) + d.substring(8,10) + d.substring(11,13) + d.substring(14,16) + d.substring(17,19);
        String id = "WL" + t + r.nextInt(1000+1);       
    ...
    private void setUpDepositLogs(int am, int Dacc) {
        Random r = new Random();
        String d = getDateTime();
        String t = d.substring(2,4) + d.substring(5,7) + d.substring(8,10) + d.substring(11,13) + d.substring(14,16) + d.substring(17,19);
        String id = "DL" + t + r.nextInt(1000+1);       
        String type = "Deposit";
        String q2 = "insert into logs(ID, Type, Acc_No, Amount, Date) values('"+id+"', '"+type+"', '"+Dacc+"', '"+am+"', '"+d+"')";
        try {
            pst = conn.prepareStatement(q2);
            pst.execute();
        } catch(Exception e) {
    ...
    private void setUpLoanLogs(int am, int Lacc) {
        Random r = new Random();
        String d = getDateTime();
        String t = d.substring(2,4) + d.substring(5,7) + d.substring(8,10) + d.substring(11,13) + d.substring(14,16) + d.substring(17,19);
        String id = "LL" + t + r.nextInt(1000+1);       
        String type = "Loan";
        String q2 = "insert into logs(ID, Type, Acc_No, Amount, Date) values('"+id+"', '"+type+"', '"+Lacc+"', '"+am+"', '"+d+"')";
        try {
            pst = conn.prepareStatement(q2);
            pst.execute();
        } catch(Exception e) {
    ...
    private void setUpLoanInstallmentLogs(int am) {
        Random r = new Random();
        String d = getDateTime();
        String t = d.substring(2,4) + d.substring(5,7) + d.substring(8,10) + d.substring(11,13) + d.substring(14,16) + d.substring(17,19);
        String id = "IL" + t + r.nextInt(1000+1);       
        String type = "EMI";
        String q2 = "insert into logs(ID, Type, Acc_No, Amount, Date) values('"+id+"', '"+type+"', '"+acc+"', '"+am+"', '"+d+"')";
        try {
            pst = conn.prepareStatement(q2);
    ...
    private void setUpLoanEarlySettlementLogs(int am) {
        Random r = new Random();
        String d = getDateTime();
        String t = d.substring(2,4) + d.substring(5,7) + d.substring(8,10) + d.substring(11,13) + d.substring(14,16) + d.substring(17,19);
        String id = "EL" + t + r.nextInt(1000+1);       
        String type = "Early Settlement";
        String q2 = "insert into logs(ID, Type, Acc_No, Amount, Date) values('"+id+"', '"+type+"', '"+acc+"', '"+am+"', '"+d+"')";
        try {
            pst = conn.prepareStatement(q2);
            pst.execute();
    ...
    private void initComponents() {
        ...
        HomeDepositSearchButton = new javax.swing.JButton();
        ...
        HomeDepositSearchButton.setFont(new java.awt.Font("Arial", 0, 14)); // NOI18N
        HomeDepositSearchButton.setIcon(new javax.swing.ImageIcon("C:\\Users\\Win 10 Pc\\Documents\\NetBeansProjects\\OOPCP\\Images\\search.gif")); // NOI18N
        HomeDepositSearchButton.setText("Search");
        HomeDepositSearchButton.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                HomeDepositSearchButtonActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(37, 37, 37)
                        .addComponent(HomeDepositSearchButton)))
        ...
        HomeTransactionsTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Date", "Type", "Name", "A/C Number", "Amount"
            }
        ));
        ...
        jLabel63.setIcon(new javax.swing.ImageIcon("C:\\Users\\Win 10 Pc\\Documents\\NetBeansProjects\\OOPCP\\Images\\Profile.png")); // NOI18N
        ...
        HomeLoanRequestTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "A/C Number", "Name", "Amount", "Duration (years)"
            }
        ));
        ...
        jLabel64.setIcon(new javax.swing.ImageIcon("C:\\Users\\Win 10 Pc\\Documents\\NetBeansProjects\\OOPCP\\Images\\Loan_Request.png")); // NOI18N
        ...
        HomeLoanTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "A/C Number", "Date", "Amount", "Duration (years)", "Installments Paid"
            }
        ));
        HomeLoanTable.setGridColor(new java.awt.Color(0, 153, 204));
        jScrollPane5.setViewportView(HomeLoanTable);

        jLabel65.setIcon(new javax.swing.ImageIcon("C:\\Users\\Win 10 Pc\\Documents\\NetBeansProjects\\OOPCP\\Images\\Loan_List.png")); // NOI18N
        ...
        jLabel66.setIcon(new javax.swing.ImageIcon("C:\\Users\\Win 10 Pc\\Documents\\NetBeansProjects\\OOPCP\\Images\\Manage_Accounts.png")); // NOI18N
        ...
        jPanel8Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(HomeTabbedPane, javax.swing.GroupLayout.PREFERRED_SIZE, 760, Short.MAX_VALUE)
                    .addGroup(jPanel8Layout.createSequentialGroup()
    ...
    private void HomeWithdrawButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HomeWithdrawButtonActionPerformed
        ...
        try {
            ...
            if(newBal >= 0 && Integer.parseInt(s2) > 0) {
                String sql = "update balance set Balance = '"+newBal+"' where Account_No = '"+acc+"'";
                pst = conn.prepareStatement(sql);
                pst.execute();
                JOptionPane.showMessageDialog(null, "Withdraw successfull");
                setUpWithdrawLogs(Integer.parseInt(s2));
                String q = "select Baseline_Bal from account where Acc_No = '"+acc+"'";
                pst = conn.prepareStatement(q);
                rs = pst.executeQuery();
                if(rs.next()) {
                    int baselineBal = rs.getInt(1);
                    if(baselineBal > newBal) {
                        String q1 = "update account set Non_Maintenance = '"+1+"' where Acc_No = '"+acc+"'";
                        pst = conn.prepareStatement(q1);
                        pst.execute();
                    }
                }
    ...
    private void HomeDepositButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HomeDepositButtonActionPerformed
        try {
            ...
            if(dep > 0) {
                ...
                setUpDepositLogs(dep,Integer.parseInt(a));
            }
            else {
                JOptionPane.showMessageDialog(null, "Please enter a valid amount");
                HomeDepositTFAmount.setText("");
    ...
    private javax.swing.JButton HomeDepositSearchButton;
